...
class TracerouteResult(SndRcvList):
    ...
    def show(self):
        ...
        return self.make_table(lambda a: (a[0].sprintf("%IP.dst%:{TCP:tcp%ir,TCP.dport%}{UDP:udp%ir,UDP.dport%}{ICMP:ICMP}"),
                                              a[0].ttl,
                                              a[1].sprintf("%-15s,IP.src% {TCP:%TCP.flags%}{ICMP:%ir,ICMP.type%}")))
