...
You can also put this line in your ``~/.kamene_startup.py`` file 
...
There is an issue tracking at http://github.com/phaethon/kamene. You are encouraged to send questions, bug reports, suggestions, ideas, cool usages of kamene, etc. to this list.
