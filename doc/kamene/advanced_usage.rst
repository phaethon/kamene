...
.. note::
   ...
   This section has not been updated for kamene yet. Code examples may not work directly. Try bytes() instead of str() and b'string' instead of b'somestring'.
...
Encoding and decoding are done using class methods provided by the codec. For example the ``BERcodec_INTEGER`` class provides a ``.enc()`` and a ``.dec()`` class methods that can convert between an encoded string and a value of their type. They all inherit from BERcodec_Object which is able to decode objects from any type::
    ...
    Traceback (most recent call last):
      ...
      File "/usr/bin/kamene", line 2099, in dec
        return cls.do_dec(s, context, safe)
      File "/usr/bin/kamene", line 2178, in do_dec
        l,s,t = cls.check_type_check_len(s)
      File "/usr/bin/kamene", line 2076, in check_type_check_len
        l,s3 = cls.check_type_get_len(s)
      File "/usr/bin/kamene", line 2069, in check_type_get_len
        s2 = cls.check_type(s)
      File "/usr/bin/kamene", line 2065, in check_type
...
::
    ...
    Traceback (most recent call last):
      ...
      File "/usr/bin/kamene", line 2099, in dec
        return cls.do_dec(s, context, safe)
      File "/usr/bin/kamene", line 2094, in do_dec
        return codec.dec(s,context,safe)
      File "/usr/bin/kamene", line 2099, in dec
        return cls.do_dec(s, context, safe)
      File "/usr/bin/kamene", line 2218, in do_dec
      ...
      File "/usr/bin/kamene", line 2099, in dec
        return cls.do_dec(s, context, safe)
      File "/usr/bin/kamene", line 2092, in do_dec
