...
from scapy3k.data import IP_PROTOS
from scapy3k.error import log_loading

from scapy3k.fields import ByteEnumField, ByteField, StrField, XIntField, IntField, \
    ShortField, PacketField

from scapy3k.packet import Packet, bind_layers, Raw

from scapy3k.layers.inet import IP, UDP
from scapy3k.layers.inet6 import IPv6, IPv6ExtHdrHopByHop, IPv6ExtHdrDestOpt, \
    IPv6ExtHdrRouting
...
#------------------------------------------------------------------------------
# The names of the encryption algorithms are the same than in scapy3k.contrib.ikev2
...
#------------------------------------------------------------------------------
# The names of the integrity algorithms are the same than in scapy3k.contrib.ikev2
# see http://www.iana.org/assignments/ikev2-parameters/ikev2-parameters.xhtml
