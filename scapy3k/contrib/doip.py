...
# scapy3k.contrib.description = DoIP
...
"""
from scapy3k.fields import ByteEnumField, IntField, StrLenField, XByteField, XShortEnumField
...
class DoIPRawPacket(Packet):
    ...
    >>> from scapy3k.contrib.doip import *
