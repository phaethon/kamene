...
from scapy3k.config import conf,ConfClass
from scapy3k.error import Scapy_Exception,log_loading,log_runtime
from scapy3k.utils import atol, itom, inet_aton, inet_ntoa, PcapReader
from scapy3k.base_classes import Gen, Net, SetGen
import scapy3k.plist as plist
from scapy3k.sendrecv import debug, srp1
from scapy3k.layers.l2 import Ether, ARP
from scapy3k.data import MTU, ETHER_BROADCAST, ETH_P_ARP

conf.use_winpcapy = True
from scapy3k.arch import pcapdnet
from scapy3k.arch.pcapdnet import *
...
import scapy3k.sendrecv
scapy3k.sendrecv.sndrcv = sndrcv
