...
from scapy3k.data import KnowledgeBase
from scapy3k.config import conf
from scapy3k.error import warning
from scapy3k.layers.inet import IP, TCP, TCPOptions
from scapy3k.packet import NoPayload
    ...
    if pers[4] != '.':
        for opt in pers[4].split(','):
            if opt[0] == 'M':
                ...
                # scapy3k RandXXX() functions, because the value has to be
