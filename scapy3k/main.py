...
def _usage():
    print("""Usage: scapy3k.py [-s sessionfile] [-c new_startup_file] [-p new_prestart_file] [-C] [-P]
...
def load_module(name):
    _load("scapy3k.modules."+name)

def load_layer(name):
    _load("scapy3k.layers."+name)

def load_contrib(name):
    _load("scapy3k.contrib."+name)
...
def interact(mydict=None,argv=None,mybanner=None,loglevel=20):
    ...
    scapy_builtins = __import__("scapy3k.all",globals(),locals(),".").__dict__
